...
// https://transportemahe.com/assets/img/logo/logo_mahe_horizontal_blanco_original.png
        ...
        html: `
            <div style="font-family:sans-serif;max-width:600px;margin:auto;">
                <div style="background:linear-gradient(135deg,#2e1c10,#8a5a2e);border-radius:12px 12px 0 0;padding:24px 32px;text-align:center;">
                    <img src="https://sitio-completo.transporte-mahe.pages.dev/assets/img/logo/logo_mahe_horizontal_blanco_original.png" alt="Transporte MAHE" style="height:44px;width:auto;display:block;margin:0 auto;">
                </div>
